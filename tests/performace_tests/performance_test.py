...
class PerformanceTest(object):
    ...
    def __init__(self):
        self.data_LOGS = pd.read_csv(".\Data\\test_data\\R_1291_LOGS.csv") 
        self.data_LOGP = pd.read_csv(".\Data\\test_data\\R_4200_LOGP.csv")
        self.data_BACE = pd.read_csv(".\Data\\test_data\\R_1513_BACE.csv")
        self.data_SAMPL = pd.read_csv(".\Data\\test_data\\R_642_SAMPL.csv") 
        self.data_AQSOLDB = pd.read_csv(".\Data\\test_data\\R_9982_AQSOLDB.csv") 
        self.data_BBBP = pd.read_csv(".\Data\\test_data\\C_2039_BBBP_2.csv") 
        self.data_HIV_3 = pd.read_csv(".\Data\\test_data\\C_41127_HIV_3.csv") 
        self.data_BACE_2 = pd.read_csv(".\Data\\test_data\\C_1513_BACE_2.csv")
        self.data_CLINTOX_2 = pd.read_csv(".\Data\\test_data\\C_1478_CLINTOX_2.csv")
